...
**Document ID:** TEST-SCEN-2024-001
**Version:** 1.0
**Date:** January 2024
...
| Approval Routing | Map to Director-level approval (PROC-POL S2.1: $250K-$499K = VP) | Required Approver: Vice-President; Note: value is in $250K-$499K range |
...
========================
Contract: VSA-2024-0472 (NovaTech Solutions Inc.)
...
| 2 | Auto-renewal for 5-year terms (S1.2) | **Major** | Exceeds 3-year maximum per PROC-POL S4 |
...
| Step | Expected Output |
|---|---|
| Template match | Matches standard NDA template; minimal deviations expected |
...
- **Insurance issues:** Cyber liability coverage of $5M (requires $15M for Data Processing per PROC-POL S6.1); no additional insured endorsement
...
1. [URGENT] GlobalServe Consulting (GS-2024-1187): DO NOT EXECUTE
...
2. [URGENT] ProMaintain Services (MSA-2021-0156): CONTRACT EXPIRED
...
3. [ACTION] SkyBridge Analytics (SPA-2024-0298): CONDITIONAL APPROVAL
...
4. [APPROVE] NovaTech Solutions (VSA-2024-0472): APPROVE
...
| Policy trigger | PROC-POL S2.3: >25% requires new contract process |
...
- Agent routing decisions align with PROC-POL approval matrix
