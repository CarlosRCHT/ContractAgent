...
IMPORTANT: Contracts are identified by contract_id, NOT by agreement numbers. When users reference an agreement number like "MSA-2021-0156", search the title or clause_text_summary fields, or match by vendor name + contract type.
