...
**Document ID:** AC-COMP-CHK-2024-001
**Version:** 2.1
...
|---|---|---|---|
| C-01 | SOC 2 Type II certification (current, within 12 months) | SOC 2 report from accredited firm | Technology vendors accessing AC systems/data |
| C-02 | ISO 27001 certification | Valid certificate from accredited body | Vendors processing or storing AC data |
...
| C-06 | Multi-factor authentication (MFA) for AC system access | Technical verification; vendor policy review | All vendors with AC system access |
...
| # | Requirement | Verification | Applies To |
|---|---|---|---|
| C-09 | All AC data stored within the domestic jurisdiction | Vendor attestation; data centre location verification | All technology vendors (default) |
...
| # | Requirement | Verification | Applies To |
|---|---|---|---|
| C-13 | Annual third-party penetration test completed | Pen test report (summary) shared with AC | All technology vendors |
